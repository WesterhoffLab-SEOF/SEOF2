...
%%%%%%%%takes the number of fibers, the fiber diameter of each (assumed the same), then reports the center of each fiber [circles] and a black
...
elseif numFibers==19
    ...
    error("only coded packing geometries for 1, 4 or 19 fibers. will need to update fiber bundle 3d before proceeding")
end
end
