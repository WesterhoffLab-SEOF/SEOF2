...
xtoy=V_in(1)/V_in(2);
[theta_i,theta_t,theta_c,~,theta_rh,~,~,direction] = Snells(V_in,nhat,ni,nt,horz_surf,directioni);
...
[I_reflect,Itrans]=FresnelEqSEOFv2(I_in,theta_i,theta_t,theta_c,ni,nt);%check there isn't a large difference after using the fresnell eq. keep
if directioni==1%hitting the end of the fiber
...
[I_scatter,Theta_scat]=scatter_cone(SystemParam,theta_rh,vert_surf);
