classdef Ray
    properties
        ...
        remaininglosses;%anything leftover?
                %performance data
        UC;%unifornmity coefficient
        RatioIsIt;%ratio between the transmitted and the side emitted light
        Y;%vector showing the distribution
